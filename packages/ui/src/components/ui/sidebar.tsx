...
import { PanelLeftIcon } from "lucide-react"; // biome-ignore lint/performance/noNamespaceImport: We need to use the namespace import for React
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    // biome-ignore lint/nursery/noShadow: We need to shadow the open variable to avoid the linter error
