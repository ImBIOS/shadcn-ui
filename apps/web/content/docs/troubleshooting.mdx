...
description: Common issues and solutions for ImBIOS UI
icon: Bug
---
...
Common issues and their solutions when using ImBIOS UI components.

## Installation Issues

### Module not found: Can't resolve '@imbios/ui'
...
1. Check the [GitHub Issues](https://github.com/ImBIOS/ui/issues)
2. Search existing discussions
3. Open a new issue with: - Error message and stack trace - Package versions (`pnpm list better-auth @imbios/ui`) - Reproduction steps - Framework and Node.js version
