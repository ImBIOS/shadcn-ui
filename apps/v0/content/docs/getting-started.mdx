...
description: Get up and running with ImBIOS UI in 5 minutes
icon: Zap
---
...
<Callout type="warn">
  If you haven't set up better-auth yet, follow the [better-auth
  documentation](https://better-auth.com/docs) first.
</Callout>
