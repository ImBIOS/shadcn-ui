...
description: Complete API reference for CredentialLoginForm component
icon: KeyRound
---
...
<Tabs items={["npm Package", "shadcn CLI"]}>
  <Tab value="npm Package">
    ```tsx import {CredentialLoginForm} from '@imbios/ui' ```
  </Tab>
  <Tab value="shadcn CLI">
    ```tsx import {CredentialLoginForm} from
    '@/components/auth/credential-login-form' ```
  </Tab>
</Tabs>
